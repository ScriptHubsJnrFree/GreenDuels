...
local C = {
    ...
    stackBg=Color3.fromRGB(4,8,6), stackBrd=Color3.fromRGB(22,50,32), stackTxt=Color3.fromRGB(105,160,125),
    stackActBg=Color3.fromRGB(14,62,36), stackActBrd=Color3.fromRGB(30,132,73), stackActTxt=Color3.fromRGB(230,245,235),
...
local function Main()
    ...
    do
        local page = buildPage("Movement", function()
            ...
            standDropBtn.TextColor3 = (currentDropType == DROP_TYPES.STAND) and Color3.fromRGB(0,20,8) or C.inputTxt
            ...
            jumpDropBtn.TextColor3 = (currentDropType == DROP_TYPES.JUMP) and Color3.fromRGB(0,20,8) or C.inputTxt
